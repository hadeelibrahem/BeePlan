...
export function StatsCard({ icon, value, title, desc }: StatsCardProps) {
  return (
    <div className="animate-[beeplanFadeIn_300ms_ease-out] rounded-2xl border border-[var(--bp-border)] bg-[var(--bp-surface)] p-4 shadow-xl transition-all duration-200 hover:-translate-y-0.5 hover:border-[var(--bp-accent)]/40">
