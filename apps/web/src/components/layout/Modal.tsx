...
export function Modal({ open, title, description, footer, onClose, initialFocusRef, size = 'sm', children }: Props) {
  ...
  useEffect(() => {
    ...
    if (initial && focusable.includes(initial)) initial.focus()
