...
export function MainTabs({ screens }: { screens?: TabScreens }) {
  const routes: Record<keyof MainTabParamList, ComponentType> = {
    Dashboard:
      screens?.Dashboard ?? (() => <StageOneRoute label="Dashboard" />),
    Tasks: screens?.Tasks ?? (() => <StageOneRoute label="Tasks" />),
    Focus: screens?.Focus ?? (() => <StageOneRoute label="Focus" />),
    Reminders:
      screens?.Reminders ?? (() => <StageOneRoute label="Reminders" />),
  ...
  return (
    ...
    >
      {MAIN_TAB_ROUTES.map((route) => (
        <Tabs.Screen key={route} name={route} component={routes[route]} />
      ))}
    </Tabs.Navigator>
  );
}
...
export function RootNavigator({
  ...
  aiTaskBuilderRoute: AiTaskBuilderRoute,
  aiDailyPlannerRoute: AiDailyPlannerRoute,
  ...
  editReminderRoute: EditReminderRoute,
  ...
  taskDetailsRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "TaskDetails">
  >;
  createTaskRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "CreateTask">
  >;
  editTaskRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "EditTask">
  >;
  aiTaskBuilderRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "AiTaskBuilder">
  >;
  aiDailyPlannerRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "AiDailyPlanner">
  >;
  calendarRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "Calendar">
  >;
  notesRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "Notes">
  >;
  analyticsRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "Analytics">
  >;
  aiCollaborationRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "AiCollaboration">
  >;
  ...
  >;
  reminderDetailsRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "ReminderDetails">
  >;
  createReminderRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "CreateReminder">
  >;
  editReminderRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "EditReminder">
  >;
  notificationsRoute?: ComponentType<
    NativeStackScreenProps<RootStackParamList, "Notifications">
  >;
  settingsRoute?: ComponentType<
  ...
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      <Stack.Screen name="MainTabs">
        {() => <MainTabs screens={tabScreens} />}
      </Stack.Screen>
      {TaskDetailsRoute ? (
        <Stack.Screen name="TaskDetails" component={TaskDetailsRoute} />
      ) : null}
      {CreateTaskRoute ? (
        <Stack.Screen name="CreateTask" component={CreateTaskRoute} />
      ) : null}
      {EditTaskRoute ? (
        <Stack.Screen name="EditTask" component={EditTaskRoute} />
      ) : null}
      {AiTaskBuilderRoute ? (
        <Stack.Screen name="AiTaskBuilder" component={AiTaskBuilderRoute} />
      ) : null}
      {AiDailyPlannerRoute ? (
        <Stack.Screen name="AiDailyPlanner" component={AiDailyPlannerRoute} />
      ) : null}
      {CalendarRoute ? (
      ...
      {AiCollaborationRoute ? (
        <Stack.Screen name="AiCollaboration" component={AiCollaborationRoute} />
      ) : null}
      {FocusSessionRoute ? (
      ...
      {ReminderDetailsRoute ? (
        <Stack.Screen name="ReminderDetails" component={ReminderDetailsRoute} />
      ) : null}
      {CreateReminderRoute ? (
        <Stack.Screen name="CreateReminder" component={CreateReminderRoute} />
      ) : null}
      {EditReminderRoute ? (
        <Stack.Screen name="EditReminder" component={EditReminderRoute} />
      ) : null}
      {NotificationsRoute ? (
