...
export const NOTIFICATION_META: Record<NotificationType, NotificationMeta> = {
  ...
  ai_upcoming_deadline: ai, ai_inactivity: { ...ai, priority: 'high' }, ai_blocked_dependency: { ...ai, priority: 'high' }, ai_dependency_completed: ai, ai_missing_assignment: ai, ai_daily_summary: ai,
};
