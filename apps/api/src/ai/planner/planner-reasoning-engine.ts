...
export class PlannerReasoningEngine {
  ...
  private systemPrompt(): string {
    return [
      ...
      'Consider: priority, due today, overdue, focus tasks, estimated duration, work already started, category, and the fixed blocks (reminders/breaks/commitments) already on the calendar.',
      'Fixed blocks of type "calendar" are the user\'s recurring commitments (e.g. university classes) — that time is unavailable; never plan work during it and order tasks around it.',
